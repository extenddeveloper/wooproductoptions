  ...
  export function App(): any {
    ...
    if (route.startsWith('builder/')) {
      ...
      switch (route) {
        ...
        case 'integrations': page = <WooOptionsFic.Pages.Integrations />; break;
        case 'diagnostics': page = <WooOptionsFic.Pages.Diagnostics />; break;
        case 'settings': page = <WooOptionsFic.Pages.Settings />; break;
        case 'help': page = <WooOptionsFic.Pages.Help navigate={navigate} />; break;
